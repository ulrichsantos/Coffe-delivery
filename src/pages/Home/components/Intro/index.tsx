...
import introImg from '../../../../assets/coffe-intro.png'
      ...
      <IntroContent className="container">
        <div>
          ...
          <BenefitsContainer>
            ...
            <InfoWithIcon icon={<Package weight="fill" />} text="Embalagem mantém o café intacto" iconBg={colors["base-text"]}/>
            <InfoWithIcon icon={<Timer weight="fill" />} text="Entrega rápida e rastreada" iconBg={colors["brand-yellow"]}/>
            <InfoWithIcon icon={<Coffee weight="fill" />} text="Compra simples e segura" iconBg={colors["brand-purple"]}/>
          </BenefitsContainer>
        </div>
